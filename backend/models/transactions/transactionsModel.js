...
const transactionObject = (data) => {
  return {
    ...
    amount: data.amount || 0, // Monto de la transacción
    paymentMethod: data.paymentMethod || 'Efecty', // Método de pago (Efecty, en este caso)
    status: data.status || 'pendiente', // Estado del pago (pendiente, confirmado, entregado)
