...
export function handlePaymentResponse(response) {
    const { userId, sellerId, id, book, status, status_detail, payment_method_id, payment_type_id, transaction_amount, description, date_created, transaction_details, fee_details, charges_details, installments, shippingDetails, card } = response;
    let message = '';
    let success = false;
