...
export default function Loader () {
  ...
  const loading = useLoadingScreen((animationInfo.animationDuration + animationInfo.animationDelay) * 1000)

  return (
    <>
    {loading && <div className="overlay"></div>}
    {loading && <div className="loader"
    style={{animationDelay: animationInfo.animationDelay + 's', animationDuration: animationInfo.animationDuration + 's'}}
    >
	...
	<circle transform="rotate(-113,100,100)" strokeLinecap="round" strokeDashoffset="439.82" strokeDasharray="439.82 439.82" strokeWidth="2" stroke="var(--using3)" fill="none" r="70" className="pencil__stroke"></circle>
