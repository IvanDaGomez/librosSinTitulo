import {FaInstagram, FaAppStore, FaGooglePlay} from 'react-icons/fa'
const Footer = () => {
    ...
    <footer className="footer">
      ...
      <div className="footer-bottom">
        <div className="newsletter">
          <input type="email" className="inputFooter" placeholder="Escribe tu correo aquí" />
          <button>Recibe novedades</button>
        </div>
