...
export const renderNotification = (notification) => {
    ...
    if (notification === 'banned') {
        ...
        <>
            ...
            <p>No podrás acceder a tu cuenta hasta que se resuelva el problema.</p>
            <p>
                No te preocupes por tu dinero, no se verá afectado. Si crees que esto es un error o necesitas ayuda, por favor{" "}
                <a href="mailto:support@meridianlib.com" style={{ color: "var(--using4)" }}>contáctanos</a>.
            </p>
            <div className="button-container">
                <Link to="/login">
