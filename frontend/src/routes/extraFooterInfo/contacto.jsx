            ...
            <div className="paraFondo">
                ...
                <div className="contactContainer">
                    ...
                    <div className="contactInfo">
                        ...
                        <hr />
                        <p>Escríbenos tus preguntas, dudas o recomendaciones.
                        ¡Te ayudaremos con mucho gusto!</p>
                        <div>
                        <a href="/chat">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color={"#42376E"} width={16} height={16} fill={"none"}>
