    ...
    return (
          <Link to={`/libros/${element._id}`}>
            <div className="sectionElement" key={index} >
                ...
                <svg onClick={(event) => userId ? handleFavoritos(event, element._id, userId): handleFavoritos(event, element._id)} className={'favoritos ' +`favorito-${element._id}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#fff"}>
                ...
                <svg onClick={(e)=> {
                  ...
                  window.location.href = `/mensajes?n=${element.idVendedor}`
