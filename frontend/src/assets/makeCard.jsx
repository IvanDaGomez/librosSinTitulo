                ...
                {(element.oferta) ? <div className="percentageElement">
                    ...
                    <div className="moreInfoElement">
                        ...
                        <div className="extraInfoElement">
                            ...
                            <svg onClick={(event) => handleFavoritos(event, element._id, userId)} className='favorites' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#000000"} fill={"none"}>
